...
@section('content')
                ...
                @include('components.leads.modal_add_lead',['title'=>"Lead Perdido",'idModal'=>'Perdido'])
                @include('components.leads.modal_add_lead',['title'=>"Lead Contato Pendente",'idModal'=>'ContatoPendente'])
                @include('components.leads.modal_add_lead',['title'=>"Lead Aguardando Retorno",'idModal'=>'AguardandoRetorno'])
                @include('components.leads.modal_add_lead',['title'=>"Lead Convertido",'idModal'=>'Convertido'])
