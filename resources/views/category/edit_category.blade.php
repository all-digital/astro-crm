            ...
            <div class="col-lg-8">
                <div class="card">
                    <div class="card-body">
                        ...
                        <form id="formVehicles" action="{{route('category-edit.update',$id)}}" method="POST">
                          @method('PUT')
                          @csrf
                                    ...
                                    <div>
                                      ...
                                      <div class="mb-3 mb-4">
                                        ...
                                        <input type="text" name="company" class="form-control  @error('company') is-invalid @enderror"
                                         value="{{ $category['company'] }}" readonly>                                             
                                        ...
                                        <div class="mb-3 mb-4" >                                                                                     
                                          ...
                                          <textarea class="form-control @error('description') is-invalid @enderror" name="description" rows="5" cols="50">{{$category['description']}}                                            
                                          </textarea>
                                          @error('description')                                           
                                            <div class="invalid-feedback">
                                            {{$message}}                                          
                                ...
                                <div class="col-lg-6">
                                    <div class="mt-4 mt-lg-0">  
                                        ...
                                        <div class="mb-3 mb-4">
                                          ...
                                          <input type="text" name="date_last_edit" class="form-control" readonly value="{{$category['updated_at'] ?? ""}}">                                          
                                        </div> 
                                        
                                        <div class="mb-3 mb-4">
                                          <label for="user_last_edit" class="form-label">Usuário da Última edição</label>
                                          <input type="text" name="user_last_edit" class="form-control" readonly value="{{$category['responsible_last_updated']?? "" }}">                                          
                                        </div> 

                                        <div class="mb-3 mb-4">
                                          <label for="user_insert" class="form-label">Usuário de Inserção</label>
                                          <input type="text" name="user_insert" class="form-control" readonly value="{{$category['responsible_for_insert']}}">                                          
                                        </div>  

                                        <div class="mb-3 mb-4">
                                          <label for="date_insert" class="form-label">Data de Inserção</label>
                                          <input type="text" name="date_insert" class="form-control" readonly value="{{$category['created_at']}}">                                          
                                        </div>                                       
